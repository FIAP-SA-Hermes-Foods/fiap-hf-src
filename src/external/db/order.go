...
var _ interfaces.OrderDB = (*orderDB)(nil)
...
func NewOrderDB(ctx context.Context, db interfaces.SQLDatabase) *orderDB {
	return &orderDB{Ctx: ctx, Database: db}
}

func (o orderDB) SaveOrder(order entity.Order) (*entity.Order, error) {
...
func (o orderDB) UpdateOrderByID(id int64, order entity.Order) (*entity.Order, error) {
...
func (o orderDB) GetOrderByID(id int64) (*entity.Order, error) {
...
func (o orderDB) GetOrders() ([]entity.Order, error) {
