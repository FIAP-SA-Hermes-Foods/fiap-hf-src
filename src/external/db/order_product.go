...
var _ interfaces.OrderProductDB = (*orderProductDB)(nil)
...
func NewOrderProductDB(ctx context.Context, db interfaces.SQLDatabase) *orderProductDB {
	return &orderProductDB{Ctx: ctx, Database: db}
}

func (o *orderProductDB) GetAllOrderProduct() ([]entity.OrderProduct, error) {
...
func (o *orderProductDB) GetAllOrderProductByOrderID(id int64) ([]entity.OrderProduct, error) {
...
func (o *orderProductDB) SaveOrderProduct(order entity.OrderProduct) (*entity.OrderProduct, error) {
