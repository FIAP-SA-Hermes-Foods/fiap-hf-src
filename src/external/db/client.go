...
var _ interfaces.ClientDB = (*clientDB)(nil)
...
func NewClientDB(ctx context.Context, db interfaces.SQLDatabase) *clientDB {
	return &clientDB{Ctx: ctx, Database: db}
}

func (c *clientDB) GetClientByID(id int64) (*entity.Client, error) {
...
func (c *clientDB) GetClientByCPF(cpf string) (*entity.Client, error) {
	if err := c.Database.Connect(); err != nil {
...
func (c *clientDB) SaveClient(client entity.Client) (*entity.Client, error) {
